...
define('trim',['common'], function(common) {
...
define('camelize',['trim'], function(trim) {
...
define('dasherize',['trim'], function(trim) {
...
define('slugify',['common', 'dasherize'], function(common, dasherize) {
...
define('vchatjs',[
    ...
    'slugify',
    'trim'
], function (hateoas, capitalize, dasherize, random, slugify, trim) {
...
//        endpoint = endpoint || "https://vchat.labsperson.com/";
    ...
    vchatjs.prototype = new hateoas(endpoint);

    // Properties
    vchatjs.VERSION = '1.0.0';

    // Methods
    vchatjs.create = function;
    vchatjs.capitalize = capitalize;
    vchatjs.dasherize = dasherize;
    vchatjs.random = random;
    vchatjs.slugify = slugify;
    vchatjs.trim = trim;
  ...
  // module value for 'vchatjs' here and return it as the
  // value to use for the public API for the built file.
  return require('vchatjs');
}));
